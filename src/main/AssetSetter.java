...
public class AssetSetter {
    ...
    public void setObject() {
        String mapName = gp.tileM.currentMap;

        // Clear existing objects
        for (int i = 0; i < gp.obj.length; i++)
            gp.obj[i] = null;

        if (mapName.equals("mymap.txt")) {
        ...
        } else if (mapName.equals("Map2.txt")) {
            // Add Map 2 specific objects here
